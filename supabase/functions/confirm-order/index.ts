...
const storeUrl="https://globalcorent.github.io/store_admin/?checkout=success";
...
Deno.serve(async req=>{
  try{
    ...
    return Response.redirect(storeUrl,303);
  }catch(error){
    console.error(error);
    return Response.redirect("https://globalcorent.github.io/store_admin/?checkout=error",303);
  }
});
